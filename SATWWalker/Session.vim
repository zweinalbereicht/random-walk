...
nnoremap  vrc :vsplit ~/.vimrc
nnoremap <silent>  gd :YcmCompleter GoTo
nnoremap  p :10 wincmd >
nnoremap  a :10 wincmd <
nnoremap  mn :Lex | :vertical resize 30
nnoremap  l :wincmd l
nnoremap  k :wincmd k
nnoremap  j :wincmd j
nnoremap  h :wincmd h
...
set helplang=fr
set incsearch
set runtimepath=~/.vim,~/.vim/plugged/vimtex,~/.vim/plugged/gruvbox,~/.vim/plugged/vim-ripgrep,~/.vim/plugged/vim-man,~/.vim/plugged/YouCompleteMe,~/.vim/plugged/goyo.vim,~/.vim/plugged/limelight.vim,~/.vim/plugged/seoul256.vim,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/vimtex/after,~/.vim/after
set shiftwidth=4
...
silent only
silent tabonly
cd ~/Dropbox/SandBox/Libraries/SATWWalker
...
wincmd w
argglobal
if bufexists("SATWWalker.h") | buffer SATWWalker.h | else | edit SATWWalker.h | endif
balt SATWWalker.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
wincmd w
argglobal
terminal ++curwin ++cols=52 ++rows=47 
