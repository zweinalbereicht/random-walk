...
ZipfWalker::ZipfWalker(string name, long pos, int seed,  double alpha) : DiscreteWalker(name, pos, seed) ,m_alpha(alpha)
{}
...
double  ZipfWalker::get_alpha() const
{
    return m_alpha;
}

void ZipfWalker::set_alpha(double alpha)
{
    m_alpha=alpha;
}
