...
// returns the probability to escape eccentric discs via the farthest one. We start from r0 and theta0
double
split_prob_eccentric_disk_choose_start(const double R_int,const double R_out, double const offset, double const theta0, double const r0, GaussianWalker &walker, const int n);
